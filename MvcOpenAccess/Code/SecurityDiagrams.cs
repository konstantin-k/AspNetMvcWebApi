...
{
	public partial class SecurityDiagrams : OpenAccessContext, ISecurityDiagramsUnitOfWork
	{
		...
		private static MetadataSource metadataSource = XmlMetadataSource.FromAssemblyResource("SecurityDiagrams.rlinq");
	
		public SecurityDiagrams()
			:base(connectionStringName, backend, metadataSource)
		{ }
		
		public SecurityDiagrams(string connection)
			:base(connection, backend, metadataSource)
		{ }
	
		public SecurityDiagrams(BackendConfiguration backendConfiguration)
			:base(connectionStringName, backendConfiguration, metadataSource)
		{ }
			
		public SecurityDiagrams(string connection, MetadataSource metadataSource)
			:base(connection, backend, metadataSource)
		{ }
		
		public SecurityDiagrams(string connection, BackendConfiguration backendConfiguration, MetadataSource metadataSource)
	...
	public interface ISecurityDiagramsUnitOfWork : IUnitOfWork
	{
